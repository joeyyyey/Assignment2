...
def train(model, trainloader, testloader, max_epoch, optimizer):
    ...
    y1 = train_loss_list
    y2 = test_loss_list
    plt.title('Training and Testing Loss Curves (NCE)')
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
    plt.plot(x,y1,color = 'green')
    plt.plot(x,y2, color = 'red')
    plt.legend(['Training Loss','Testing Loss'], loc = 'upper right')
    plt.savefig('p2-loss-nce.jpg',
            format='jpeg',
            dpi=300)
    plt.close()
    ...
    y1 = acc_train_list
    y2 = acc_test_list
    plt.title('Training and Testing Accuracy Curves (NCE)')
    plt.xlabel('Epoch')
    plt.ylabel('Accuracy')
    plt.plot(x,y1,color = 'green')
    plt.plot(x,y2, color = 'red')
    plt.legend(['Training Accuracy','Testing Accuracy'], loc = 'lower right')
    plt.savefig('p2-accuracy-nce.jpg',
            format='jpeg',
            dpi=300)
